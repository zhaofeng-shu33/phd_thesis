...
Let $\mu=\frac{1}{n}\mathbf{1}_n^T h$ and $\lambda = -\frac{\mu}{n}$. Specify $(a_1,\ldots,a_{n+1},$ $\lambda_1,\ldots,\lambda_{n+1})$ as follows
...
The matrix $A=(B+J_n-I_n)/2$ is the adjacency matrix of the graph.
