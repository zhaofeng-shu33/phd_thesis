...
\begin{abstract}
 ...
 为算法超参的选取提供了理论依据。
  ...
  揭示了
  极限情况下社团发现算法可达的最优误差率，从而为算法的检测效果提供了理论保证。
  信息论度量的引入也指导了算法的设计和性能优化，
  对于实际网络中的社团发现问题有
  重要参考价值和借鉴意义。
...
\begin{abstract*}
  ...
  As a result, we theoretically establish a unified framework for analyzing common \highlight{objective} functions for community discovery.
  ...
  \thusetup{
    keywords* = {Community detection, Stochastic block model, Multivariate mutual information, Rate function, Rényi divergence},
  }
\end{abstract*}
