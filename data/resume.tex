...
\begin{resume}
  ...
  \begin{achievements}
    ...
    \newblock Exact recovery of stochastic block model by \highlight{Ising}
      model\allowbreak[J].
    ...
    \newblock Performance-guaranteed \highlight{ODE} solvers with complexity-informed neural
