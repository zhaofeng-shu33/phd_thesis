...
\begin{figure}[H]
	...
	的图示}\label{fig:phase_transition_theorem_illustration}
\end{figure}
...
$g(\bar{\beta}) < 0$。 The~illustration of $g(\beta), \tilde{g}(\beta)$ is shown in Figure~\ref{fig1}a.
...
in polynomial speed.
Therefore, Theorem \ref{thm:phase_transition} establishes the sharp phase transition property of the Ising model, which is illustrated
